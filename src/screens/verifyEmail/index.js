...
import Please from '../../../assets/images/messages.svg';
...
const VerifyEmail = ({navigation}) => {
  ...
  return (
      ...
      <ImageBackground source={require('../../../assets/images/image.png')}  style={{width:'100%',height:'100%',opacity:1}}>
         ...
         <TouchableOpacity onPress={()=>navigation.goBack('forgetpassword')}>
    ...
    <Greater/>
     ...
     <Text style={styles.Txt}>Verify E-mail</Text>
</View>
     </View>

     <View style={{marginTop:'30%',alignItems:'center'}}>
     <Please width={237.93} height={256.11}/>

     </View>

     <View style={{marginTop:47.89,alignItems:'center'}}>
     <Text style={styles.SecontTxt}>Please enter the verification code </Text>
     <Text style={styles.passwordTxt}>sent to your email</Text>
     ...
     <View style={{ marginTop:49,width:'100%',justifyContent:'center',alignItems:'center',flexDirection:'row'}}>
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate('changepassword')} disabled={FirstTxt!=='' && SecondTxt!=='' && ThirdTxt!=='' && FourthTxt!=='' && FifthTxt!=='' && SixthTxt!=='' ? false:true} style={[styles.TouchBox,{backgroundColor:FirstTxt !=='' && SecondTxt !=='' && ThirdTxt !== '' && FourthTxt!== '' && FifthTxt!==''  && SixthTxt!==''? 'blue':'grey' }]}>
